...
func addMusic(engine: Engine) async throws {
  ...
  try engine.block.setString(
    ...
    value: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.76.0-rc.1/assets/ly.img.audio/audios/far_from_home.m4a",
  )
  ...
  let audioSourceID = try await engine.asset.addLocalAssetSourceFromJSON(
    URL(string: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.76.0-rc.1/assets/ly.img.audio/content.json")!,
  )
  ...
  try engine.block.setString(
    backgroundAudio,
    property: "audio/fileURI",
    value: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.76.0-rc.1/assets/ly.img.audio/audios/dance_harder.m4a",
  )
