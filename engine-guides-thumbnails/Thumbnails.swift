...
private final class StockPhotoSource: NSObject, AssetSource {
  ...
  private let host = "https://cdn.img.ly/packages/imgly/cesdk-swift/1.78.0-rc.2/assets"
...
func thumbnails(engine: Engine) async throws {
  ...
  let baseURL = "https://cdn.img.ly/packages/imgly/cesdk-swift/1.78.0-rc.2/assets"
