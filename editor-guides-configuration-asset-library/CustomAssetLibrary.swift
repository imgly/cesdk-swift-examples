...
struct CustomAssetLibrary: AssetLibrary {
  ...
  @AssetLibraryBuilder var text: AssetLibraryContent {
    AssetLibrarySource.textPreset(.title("Plain Text"), source: .init(id: "ly.img.text"))
    AssetLibrarySource.textPreset(.title("Text Styles"), source: .init(id: "ly.img.text.styles"))
    AssetLibrarySource.textComponent(.title("Text Designs"), source: .init(id: "ly.img.text.components"))
    AssetLibrarySource.textPreset(.title("Curved Text"), source: .init(id: "ly.img.text.curves"))
  }
