...
func uriResolver(engine: Engine) async throws {
  ...
  // This will return "https://cdn.img.ly/packages/imgly/cesdk-js/1.77.0-rc.0/assets/banana.jpg"
  ...
  // "https://cdn.img.ly/packages/imgly/cesdk-js/1.77.0-rc.0/assets/banana.jpg" like before.
  try await engine.editor.getAbsoluteURI(relativePath: "/banana.jpg")
  // highlight-remove-resolver
}
