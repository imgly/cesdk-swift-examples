...
func exportToMp4(engine: Engine) async throws {
  ...
  try engine.block.setString(
    ...
    value: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.76.0-rc.3/assets/ly.img.video/videos/pexels-drone-footage-of-a-surfer-barrelling-a-wave-12715991.mp4",
  )
