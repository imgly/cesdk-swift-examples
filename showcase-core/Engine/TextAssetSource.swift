...
public final class TextAssetSource: NSObject {
  private let assets: [IMGLYEngine.AssetResult] = [
...
extension TextAssetSource: IMGLYEngine.AssetSource {
  ...
  public var credits: IMGLYEngine.AssetCredits? { nil }

  public var license: IMGLYEngine.AssetLicense? { nil }
}
